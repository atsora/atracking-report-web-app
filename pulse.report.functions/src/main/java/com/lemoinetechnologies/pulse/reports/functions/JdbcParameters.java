...
package com.lemoinetechnologies.pulse.reports.functions;
...
public class JdbcParameters {
	...
	/**
	 * @return the JDBC URL taken from the DSN Name LemoineGDB with the help of the
	 *         reg.exe command
	 */
	...
	public static String getLemoineGDBUrlFromDbConnectionKey() {
		String dbConnectionValue = getRegStringValue("\"HKLM\\SOFTWARE\\Lemoine\\PULSE\"", "DbConnection.DatabaseName");
