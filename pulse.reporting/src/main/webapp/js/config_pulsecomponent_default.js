...
PULSE_DEFAULT_CONFIG.general = {
  ...
  /* The following def are BELOW in tagConfig :
    reportpath: 'http://serveraddress:8080/pulsereporting/',
    pulsewebapppath: '', // 'http://serveraddress:8080/pulsewebapp', // Value usefull for reporting links
...
PULSE_DEFAULT_CONFIG.roles = {
  ...
  support: { // == idem manager + live + reports
    displayedApps: [
      ...
      'Reports' // use reportpath = 'http://serveraddress:8080/pulsereporting/'
    ]
  },
...
var tagConfig = {
  ...
  reportpath: 'http://serveraddress:8080/pulsereporting/', // Done - "/" is mandatory for Ford
  pulsewebapppath: '', // 'http://serveraddress:8080/pulsewebapp', // Value usefull for reporting links
  mainpath: '', //Warning '/' needed at the end - SHOULD BE EMPTY when INSTALL
